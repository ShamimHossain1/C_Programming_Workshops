...
struct ReportData calculateReportData(struct CatFoodInfo cfi) {
	...
	ReportData.skuNumber = cfi.skuNumber;
	ReportData.productPrice = cfi.productPrice;
	ReportData.productWeightPounds = cfi.productWeight;
	ReportData.calories = cfi.calories;
	
	
	ReportData.productWeightKilos = convertLbsKg(&ReportData.productWeightPounds, &ReportData.productWeightKilos);
	ReportData.productWeightGrams = convertLbsG(&ReportData.productWeightPounds, &ReportData.productWeightGrams);
	ReportData.servings = calculateServings(GRAMS_NUMBER, ReportData.productWeightGrams, &ReportData.servings);

	double totalCalories = ReportData.calories * ReportData.servings;

	ReportData.costPerServing = calculateCostPerServing(&ReportData.productPrice, &ReportData.servings, &ReportData.costPerServing);
	ReportData.costCaloriesPerServing = calculateCostPerCal(&ReportData.productPrice, &totalCalories, &ReportData.costCaloriesPerServing);
